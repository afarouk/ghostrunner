...
require('file?name=[name].[ext]!./preprocessing.php');
require('file?name=[name].[ext]!./php/Mobile_Detect.php');
require('file?name=[name].[ext]!./php/parser_api_utility.php');
require('file?name=[name].[ext]!./php/detecturl.php');
