						...
						success: function(msg) {
							if (parseInt(msg, 0) !== 0) {
								...
								if (msg_split[0] === 'success') {
									...
									$submit.removeAttr('disabled');
									$form.siblings('.submit-status').html('<span class="success"><i class="fa fa-check-circle"></i> ' + msg_split[1] + '</span>').fadeIn(300).delay(3000).fadeOut(300);
								} else {
									...
									$submit.removeAttr('disabled');
									$form.siblings('.submit-status').html('<span class="error"><i class="fa fa-exclamation-circle"></i> ' + msg_split[1] + '</span>').fadeIn(300).delay(3000).fadeOut(300);
								}
							}
						}
					});
